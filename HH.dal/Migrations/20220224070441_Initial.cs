        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestFile = table.Column<string>(type: "text", nullable: true),
                    DownloadFile = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AboutUsTranslates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AboutUsTranslates_AboutUs_AboutUsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BannerTranslates_Banner_BannerId",
                        column: x => x.BannerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LocationTranslates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LocationTranslates_Location_LocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MissionTranslates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MissionTranslates_Mission_MissionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OptionCode = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductTranslates_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StatusTranslates_Status_StatusId",
                        column: x => x.StatusId,
                        principalTable: "Status",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OptionContent", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OptionContent_Option_OptionId",
                        column: x => x.OptionId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectTranslates_Project_ProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "text", nullable: false),
                    LanguageCulture = table.Column<string>(type: "text", nullable: false),
                    OptionContentId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OptionContentTranslates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OptionContentTranslates_OptionContent_OptionContentId",
                        column: x => x.OptionContentId,
                        principalTable: "OptionContent",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_AboutUsTranslates_AboutUsId",
                table: "AboutUsTranslates",
                column: "AboutUsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LocationTranslates_LocationId",
                table: "LocationTranslates",
                column: "LocationId");

            migrationBuilder.CreateIndex(
                name: "IX_MissionTranslates_MissionId",
                table: "MissionTranslates",
                column: "MissionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OptionContent_OptionId",
                table: "OptionContent",
                column: "OptionId");

            migrationBuilder.CreateIndex(
                name: "IX_OptionContentTranslates_OptionContentId",
                table: "OptionContentTranslates",
                column: "OptionContentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StatusTranslates_StatusId",
                table: "StatusTranslates",
                column: "StatusId");
        }
